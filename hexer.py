...
parser.add_argument('-o', '--op', dest='op_tuple', metavar='OP', action='store', type=arithmetic_operation,
                    help='operation to perform: \'*\' or x or . for multiplication, + for addition, - for subtraction, / or ÷ for division; ++ (or +++ or ...) for addition with 3 (or 4 or more) addends. Default is multiplication')
